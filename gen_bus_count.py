...
for line in ['线路6','线路11']:
    gd_bus_line_count = gd_train_data[gd_train_data.line_name==line].groupby('deal_time')['terminal_id'].nunique()
    print gd_bus_line_count
    count_name = './data/bus_count/'+line+'_bus_count.txt'
    gd_bus_line_count.to_csv(count_name)
