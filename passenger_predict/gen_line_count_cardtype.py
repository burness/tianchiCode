...
for line in ['线路6','线路11']:
    gd_train_line_count = gd_train_data[gd_train_data['line_name']==line].groupby('card_type')['deal_time'].value_counts()
    count_name = './data/count/'+line+'_count_cardtype.txt'
    gd_train_line_count.to_csv(count_name)
# print gd_train_count
# print gd_train_data.head(10)__author__ = 'burness'
